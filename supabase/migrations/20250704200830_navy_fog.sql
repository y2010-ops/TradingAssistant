/*
  ...
  1. New Tables
    ...
    - `sentiment_data` - Sentiment analysis results from various sources
    - `trading_signals` - AI-generated trading recommendations
    - `price_history` - Historical price data for stocks
    - `users` - User accounts and preferences
    - `user_queries` - Chat history and AI interactions
  ...
  3. Performance
    ...
    - Optimize for real-time data access
*/
...
DROP POLICY IF EXISTS "Users can read own queries" ON user_queries;
DROP POLICY IF EXISTS "Users can insert own queries" ON user_queries;
...
DROP POLICY IF EXISTS "Users can read public watchlists" ON watchlists;
